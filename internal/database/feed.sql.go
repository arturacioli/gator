...
SELECT f.id, f.created_at, f.updated_at, f.name, url, user_id, last_fetched_at, u.id, u.created_at, u.updated_at, u.name FROM feeds as f inner join users as u on f.user_id = u.id
`
